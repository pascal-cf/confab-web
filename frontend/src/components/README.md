...
| `CTALinks.tsx` | Trio of pill links (Demo → demo.confabulous.dev, Docs → docs.confabulous.dev Introduction page, GitHub → confab-web repo). Rendered above and below the `HeroCards` grid on the landing page. |
